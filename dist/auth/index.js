...
var UserNotFoundException = /*#__PURE__*/function (_Error) {
  ...
  var _super = _createSuper(UserNotFoundException);

  function UserNotFoundException() {
    _classCallCheck(this, UserNotFoundException);

    return _super.call(this, "User not found");
  }

  return _createClass(UserNotFoundException);
}( /*#__PURE__*/_wrapNativeSuper(Error));

exports.UserNotFoundException = UserNotFoundException;

var InvalidPasswordException = /*#__PURE__*/function (_Error2) {
  _inherits(InvalidPasswordException, _Error2);

  var _super2 = _createSuper(InvalidPasswordException);

  function InvalidPasswordException() {
    _classCallCheck(this, InvalidPasswordException);

    return _super2.call(this, "Invalid password");
  }

  return _createClass(InvalidPasswordException);
}( /*#__PURE__*/_wrapNativeSuper(Error));
