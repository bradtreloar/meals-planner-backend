...
var initModels = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(sequelize) {var _iterator, _step, modelDefinition, _iterator2, _step2, associationsDefinition;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_iterator = _createForOfIteratorHelper(
            models.modelDefinitions);try {for (_iterator.s(); !(_step = _iterator.n()).done;) {modelDefinition = _step.value;
                modelDefinition(sequelize);
              }} catch (err) {_iterator.e(err);} finally {_iterator.f();}_iterator2 = _createForOfIteratorHelper(
            models.associationsDefinitions);try {for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {associationsDefinition = _step2.value;
                associationsDefinition();
              }} catch (err) {_iterator2.e(err);} finally {_iterator2.f();}_context.next = 6;return (
              sequelize.sync());case 6:case "end":return _context.stop();}}}, _callee);}));return function initModels(_x) {return _ref.apply(this, arguments);};}();exports.initModels = initModels;var


User = /*#__PURE__*/function (_Model) {_inherits(User, _Model);var _super = _createSuper(User);function User() {_classCallCheck(this, User);return _super.apply(this, arguments);}return _createClass(User);}(_sequelize.Model);exports.User = User;
...
function (sequelize) {
  User.init(_objectSpread({
    ...
    id: (0, _helpers.primaryKey)(),
    email: {
      type: new _sequelize.DataTypes.STRING(128),
      allowNull: false },

    password: {
      type: new _sequelize.DataTypes.STRING(2048),
      allowNull: false } },
